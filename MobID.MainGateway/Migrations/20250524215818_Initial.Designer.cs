...
namespace MobID.MainGateway.Migrations
{
    ...
    [Migration("20250524215818_Initial")]
            ...
            modelBuilder.Entity("MobID.MainGateway.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$KiiY0RyKZgCokqGb2Xcp2uXtSv3YzXhL1cTWFRdobMIuqa/tN7yF2",
                            UpdatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Username = "admin"
                        },
                        new
            ...
            modelBuilder.Entity("MobID.MainGateway.Models.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            UpdatedAt = new DateTime(2025, 5, 24, 21, 58, 17, 676, DateTimeKind.Utc).AddTicks(5108)
                        },
                        new
                        {
                            ...
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsActive = true,
                            UpdatedAt = new DateTime(2025, 5, 24, 21, 58, 17, 676, DateTimeKind.Utc).AddTicks(5115)
                        });
                });
