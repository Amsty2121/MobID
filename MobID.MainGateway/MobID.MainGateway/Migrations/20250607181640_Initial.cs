    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), 0, new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7637), null, "Valabil o singură scanare", "OneUse", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7639) },
                    { new Guid("00000000-0000-0000-0000-000000000002"), 1, new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7743), null, "Ex: 8 scanări. Se scade la fiecare utilizare.", "LimitedUse", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7744) },
                    { new Guid("00000000-0000-0000-0000-000000000003"), 2, new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7747), null, "Se resetează lunar, opțional cu limită", "Subscription", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7748) },
                    { new Guid("00000000-0000-0000-0000-000000000004"), 3, new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7751), null, "Acces complet fără restricții", "Unlimited", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7751) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7917), null, "Administrator role", "Admin", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7919) },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7927), null, "Organization user role", "OrgUser", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7927) },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7929), null, "Simple user role", "SimpleUser", new DateTime(2025, 6, 7, 18, 16, 39, 868, DateTimeKind.Utc).AddTicks(7930) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(5991), null, "admin@example.com", "$2a$11$bWpjRDRMS.cEuHT8ZPkYUetwOFp0fbRxRI4TuKr2aBSBvS4sjLQjC", new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(5992), "admin" },
                    { new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(5997), null, "user@example.com", "$2a$11$bWpjRDRMS.cEuHT8ZPkYUetwOFp0fbRxRI4TuKr2aBSBvS4sjLQjC", new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(5997), "user" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(6119), null, new Guid("11111111-2222-3333-4444-555555555555"), true, new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(6119) },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(6125), null, new Guid("66666666-7777-8888-9999-aaaaaaaaaaaa"), true, new DateTime(2025, 6, 7, 18, 16, 39, 984, DateTimeKind.Utc).AddTicks(6125) }
                });
